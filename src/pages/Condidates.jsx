...
const Condidates = () => {
  return (
    <div className="p-4">
      ...
      <TableUsersDesktop infoColumnsCandidate={TABLE_HEAD} infoCondidate={TABLE_ROWS} />
       </div>

       <div className="display_non_lg">
      <TableUsersTelephone  infoColumnsCandidate={TABLE_HEAD} infoCondidate={TABLE_ROWS} />
       </div>
