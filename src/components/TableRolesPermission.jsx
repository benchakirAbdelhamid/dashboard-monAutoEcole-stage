                  ...
                  <tr key={id} className="border_bottom_gray">
                    ...
                    <td className="p-4 ">
                      ...
                      <Dialog open={openUpdate} onClose={handleCloseUpdate}>
                        ...
                        <div className="w-full text-center">
                          <div className="mb-3"> Update media? </div>
                          <DialogContentText>
                        ...
                        >
                          ...
                          <button
                            ...
                            class="middle none center mr-2  bg-[#3f41cae3] py-3 px-14 font-sans text-sm  text-white shadow-mdtransition-all  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                          ...
                          <button
                            style={{ borderRadius: "50px" }}
                            onClick={handleCloseUpdate}
                            class=" middle none center ml-2 bg-[#c92e2ee2] py-3 px-14 font-sans text-sm   text-white shadow-md transition-all  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    ...
                    <td className="p-4 ">
                      ...
                      <Dialog open={open} onClose={handleClose}>
                        ...
                        <div className="w-full text-center">
                          <div className="mb-3"> Delete media? </div>
                          <DialogContentText>
                            <div className=" text-[#504f4f] ">
                              ...
                              <div className="flex flex-col ">
                                {permissionsRole.map((x) => {
                                  return (
                                    ...
                                    >
                                      <label
                                        class="relative flex cursor-pointer items-center rounded-full p-1.5"
                                        htmlFor="ripple-on"
