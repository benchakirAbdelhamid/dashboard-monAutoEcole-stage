...
import { AddRoad, AddToDrive } from "@mui/icons-material";
...
const DialogAddPermission = (props) => {
  ...
  const handleClose = () => {
    setOpen(false);
    console.log('add new permission ',name)
  };
  const handleInput = (e)=>{
          ...
          <div className="dialogBody_checkbox">
            <div className="mb-4 flex flex-col gap-6">
              <div className="relative h-11 w-full min-w-[200px]">
                <input  value={name} onChange={handleInput} className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" />
