...
const DialogAddPermission = (props) => {
  ...
  return (
    <>
      <button
        class="flex select-none items-center gap-2 rounded-lg border border-blue-gray-500 py-2.5 px-4 text-center align-middle font-sans text-sm font-bold uppercase text-blue-gray-500 transition-all hover:opacity-75 focus:ring focus:ring-blue-gray-200 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        type="button"
