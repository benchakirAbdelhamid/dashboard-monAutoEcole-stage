...
export default function SliderNotification() {
  ...
  const listNotification = [
    {
      id : 1,
      title : 'Un condidat a ete passe un ...',
      time : '4m ago',
      icon : <ImageIcon />
    },
    {
      id : 2,
      title : 'Nouveau inscription',
      time : '1:23 AM',
      icon : <WorkIcon />
    },
    {
  ...
  const list = (anchor) => (
    ...
    >
      <h2 className='pt-4 pl-4 title_notification' style={{'fontWeight':'600','fontSize':'20px'}} >
        Notifications
      </h2>
       <List 
      sx={{
...
{listNotification.map((item) => (
   ...
   <ListItemText primary={item.title} secondary={item.time} className='xx' />
 </ListItem>
))}
